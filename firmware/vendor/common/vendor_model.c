...
#include "vendor/user_lib/user_model.h"
#include "vendor/user_lib/app_lcd_model.h"
...
mesh_cmd_sig_func_t mesh_cmd_vd_func[] = {
    ...
    #endif
#endif
    {VD_BTN_SCENE_SET, 0, VENDOR_MD_LIGHT_C, VENDOR_MD_LIGHT_S, cb_vd_btn_scene_set, VD_BTN_SCENE_STATUS},
    {VD_BTN_SCENE_STATUS, 1, VENDOR_MD_LIGHT_S, VENDOR_MD_LIGHT_C, cb_vd_btn_scene_sts, STATUS_NONE},
